ShitcoinDeLuxe Core version 0.10.4.0 is now available from:

  <https://download.ShitcoinDeLuxe.org/ShitcoinDeLuxe-0.10.4.0/>
...
**Notice to miners:** ShitcoinDeLuxe Core’s block templates are now for
version 4 blocks only, and any mining software relying on its
getblocktemplate must be updated in parallel to use libblkmaker either
version v0.4.3 or any version from v0.5.2 onward.

- If you are solo mining, this will affect you the moment you upgrade
  ShitcoinDeLuxe Core, which must be done prior to BIP65 achieving its 951/1001
  status.
...
entire blockchain after an unclean shutdown of ShitcoinDeLuxe Core on Windows
...
This section describes the ShitcoinDeLuxe-specific differences.
