ShitcoinDeLuxe Core version 0.13.3 is now available from:

  <https://download.ShitcoinDeLuxe.org/ShitcoinDeLuxe-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/ShitcoinDeLuxe-project/ShitcoinDeLuxe/blob/0.13/src/chainparams.cpp#L214).
