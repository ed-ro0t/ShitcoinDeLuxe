...
This guide describes how to build ShitcoinDeLuxed and command-line utilities on OpenBSD.
...
The default C++ compiler that comes with OpenBSD 6.2 is g++ 4.2.1. This version is old (from 2007), and is not able to compile the current version of ShitcoinDeLuxe Core because it has no C++11 support. We'll install a newer version of GCC:
