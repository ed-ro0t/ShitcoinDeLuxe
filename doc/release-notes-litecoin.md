ShitcoinDeLuxe Core version *0.15.1* is now available from:

  <https://download.ShitcoinDeLuxe.org/ShitcoinDeLuxe-0.15.1/>
...
A number of changes to the way ShitcoinDeLuxe Core deals with peer connections and invalid blocks
