...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ShitcoinDeLuxe-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ShitcoinDeLuxe-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ShitcoinDeLuxe transaction") + "\n" +
              "  ShitcoinDeLuxe-tx [options] -create [commands]   " + _("Create hex-encoded ShitcoinDeLuxe transaction") + "\n" +
              "\n";
