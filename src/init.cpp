...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ShitcoinDeLuxe-project/ShitcoinDeLuxe>";
    const std::string URL_WEBSITE = "<https://ShitcoinDeLuxe.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("ShitcoinDeLuxe version %s\n", FormatFullVersion());
}
