...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 SHT"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 SHT"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 SHT"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 SHT"));
        ...
        labelBalance->setText(QStringLiteral("123.456 SHT"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for ShitcoinDeLuxe transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for ShitcoinDeLuxe transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
