...
"QLabel { color: rgb(40,40,40);  }"));
    ...
    void retranslateUi(ModalOverlay *ModalOverlay)
    {
        ...
        infoTextStrong->setText(QApplication::translate("ModalOverlay", "Attempting to spend litecoins that are affected by not-yet-displayed transactions will not be accepted by the network.", Q_NULLPTR));
